...
topics: [javascript, browserify, node]
---
...
For an example of running similar tasks for bundling css that's packaged through npm, check out this article: [Using rework-npm for bundling css from npm along with myth and clean-css](http://makerlog.org/posts/rework-npm-myth-clean-css/)
